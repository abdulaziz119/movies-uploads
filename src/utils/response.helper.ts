...
import { getPaginationResponse } from './pagination.builder';
...
export class ResponseHelper {
  ...
  static success(
    ...
    return res
      .status(statusCode)
      .json(ResponseHelper.successObject(data, statusCode));
  }
  ...
  static error(
    ...
    return res
      .status(statusCode)
      .json(ResponseHelper.errorObject(message, statusCode, details));
  }
